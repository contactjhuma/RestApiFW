...
import com.jhuma.api.endpoins.UserEndPoints2;
...
public class UserTest2 {
    ...
    public void testPostUser(){
        ...
        Response response= UserEndPoints2.ctreateUser(userPayload);
    ...
    public void testtUserUpadteByName(){
        ...
        Response response=UserEndPoints2.updateUser(this.userPayload.getUsername(), userPayload1);
